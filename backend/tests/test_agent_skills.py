...
class TestLoadSkillMetadata:
    def test_with_frontmatter(
        self, service: AgentSkillsService, skill_dir: Path
    ) -> None:
    ...
    def test_without_frontmatter(
        self, service: AgentSkillsService, skill_no_frontmatter: Path
    ) -> None:
...
class TestDiscoverSkills:
    def test_discovers_skills_in_directory(
        self, service: AgentSkillsService, skill_dir: Path
    ) -> None:
    ...
    def test_skips_dirs_without_skill_md(
        self, service: AgentSkillsService, tmp_path: Path
    ) -> None:
...
class TestBuildSystemPromptSection:
    ...
    def test_empty_for_unknown_skills(
        self, service: AgentSkillsService, skill_dir: Path
    ) -> None:
        with patch.object(service, "_get_skill_directories", return_value=[skill_dir]):
            service.discover_skills()
